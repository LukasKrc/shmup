...
public class DefaultCollisionFinder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "lt.Shmup.Main.GameObject.CollisionFinders.DefaultCollisionFinder"; 
  ...
  public void setSystemProperties() {
    ...
    java.lang.System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar6472161705795834519.jar"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultCollisionFinder_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultCollisionFinder_ESTest_scaffolding.class.getClassLoader()); 
