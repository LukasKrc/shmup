...
public class EnemyFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "lt.Shmup.Main.GameObject.Factories.Entity.EnemyFactory"; 
  ...
  public void setSystemProperties() {
    ...
    java.lang.System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar3727395358011734222.jar"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EnemyFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EnemyFactory_ESTest_scaffolding.class.getClassLoader()); 
