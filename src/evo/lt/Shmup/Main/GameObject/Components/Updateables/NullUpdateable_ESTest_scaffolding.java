...
public class NullUpdateable_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "lt.Shmup.Main.GameObject.Components.Updateables.NullUpdateable"; 
  ...
  public void setSystemProperties() {
    ...
    java.lang.System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar483197988759768737.jar"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NullUpdateable_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NullUpdateable_ESTest_scaffolding.class.getClassLoader()); 
