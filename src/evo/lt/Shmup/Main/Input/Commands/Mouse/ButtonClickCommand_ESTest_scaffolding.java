...
public class ButtonClickCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "lt.Shmup.Main.Input.Commands.Mouse.ButtonClickCommand"; 
  ...
  public void setSystemProperties() {
    ...
    java.lang.System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar9109463687519480352.jar"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ButtonClickCommand_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ButtonClickCommand_ESTest_scaffolding.class.getClassLoader()); 
